          ...
          <div className="max-w-md w-full space-y-8 text-center">
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href={"/"}>
                  <button className="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600  font-semibold rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 text-white">
                    <HiHome className="mr-2 h-5 w-5" />
                    Home
                  </button>
                </Link>
                <Link href={"/orders"}>
                  <button className="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600  font-semibold rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 text-white">
                    <HiInformationCircle className="mr-2 h-5 w-5" />
                    Orders
                  </button>
                </Link>
                <Link href={"/contact"}>
                  <button className="inline-flex items-center px-4 py-2 bg-purple-500 hover:bg-purple-600  font-semibold rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 text-white">
